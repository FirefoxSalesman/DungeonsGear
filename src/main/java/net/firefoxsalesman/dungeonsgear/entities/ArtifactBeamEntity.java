package net.firefoxsalesman.dungeonsgear.entities;

import net.firefoxsalesman.dungeonsgear.items.artifacts.beacon.AbstractBeaconItem;
import net.firefoxsalesman.dungeonsgear.items.artifacts.beacon.BeamColor;
import net.firefoxsalesman.dungeonsgear.network.entity.PlayerBeamMessage;
