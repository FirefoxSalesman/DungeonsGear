package net.firefoxsalesman.dungeonsgear.items.ranged.crossbows;

import static net.firefoxsalesman.dungeonsgear.capabilities.GearCapabilities.DUAL_WIELD_CAPABILITY;
