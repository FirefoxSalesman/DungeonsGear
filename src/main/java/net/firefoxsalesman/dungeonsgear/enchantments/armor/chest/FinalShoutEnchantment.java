...
import static net.firefoxsalesman.dungeonsgear.registry.EnchantmentInit.FINAL_SHOUT;

import net.firefoxsalesman.dungeonsgear.enchantments.types.HealthAbilityEnchantment;
