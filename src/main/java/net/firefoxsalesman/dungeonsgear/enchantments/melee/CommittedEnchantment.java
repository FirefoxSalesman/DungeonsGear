...
import static net.firefoxsalesman.dungeonsgear.config.DungeonsGearConfig.COMMITTED_BASE_MULTIPLIER;
import static net.firefoxsalesman.dungeonsgear.config.DungeonsGearConfig.COMMITTED_MULTIPLIER_PER_LEVEL;
