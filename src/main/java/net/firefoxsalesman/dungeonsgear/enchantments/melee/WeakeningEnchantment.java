...
import static net.firefoxsalesman.dungeonsgear.config.DungeonsGearConfig.WEAKENING_DISTANCE;
import static net.firefoxsalesman.dungeonsgear.config.DungeonsGearConfig.WEAKENING_DURATION;
