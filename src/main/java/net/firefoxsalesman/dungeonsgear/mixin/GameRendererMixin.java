...
public abstract class GameRendererMixin {
	...
	// @Redirect(method = "pick", at = @At(value = "INVOKE", ordinal = 0, target =
	// "Lnet/minecraft/util/math/vector/Vector3d;distanceToSqr(Lnet/minecraft/util/math/vector/Vector3d;)D"))
	...
	// }
	// @Redirect(method = "pick", at = @At(value = "INVOKE", ordinal = 1, target =
	// "Lnet/minecraft/util/math/vector/Vector3d;distanceToSqr(Lnet/minecraft/util/math/vector/Vector3d;)D"))
	...
	// mc.player.getAttributeValue(AttributeRegistry.ATTACK_REACH.get());
