...
import static net.firefoxsalesman.dungeonsgear.config.DungeonsGearConfig.RAMPAGING_CHANCE;
import static net.firefoxsalesman.dungeonsgear.config.DungeonsGearConfig.RAMPAGING_DURATION;
