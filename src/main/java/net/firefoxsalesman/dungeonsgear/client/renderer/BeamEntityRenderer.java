package net.firefoxsalesman.dungeonsgear.client.renderer;
...
import net.firefoxsalesman.dungeonsgear.entities.ArtifactBeamEntity;
import net.firefoxsalesman.dungeonsgear.items.artifacts.beacon.BeamColor;
import net.firefoxsalesman.dungeonsgear.items.artifacts.beacon.MyRenderType;
