...
import net.firefoxsalesman.dungeonsgear.client.renderer.BeamEntityRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.ghosts.SoulWizardRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.projectiles.SoulWizardOrbRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.totem.BuzzyNestRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.totem.FireworksDisplayRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.totem.TotemOfRegenerationRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.totem.TotemOfShieldingRenderer;
import net.firefoxsalesman.dungeonsgear.client.renderer.totem.TotemOfSoulProtectionRenderer;
